...
const data: Project[] = [
  {
    ...
    imageAlt: 'Website with a purple header and navigation menu; large white text on a wooden background reads, “The Cluck is Ticking.”.',
    date: '2026-10-20',
  ...
  },
  {
    ...
    imageAlt: 'A stick figure holding a camera takes a photo of food on a table, with a trash can nearby, on a purple background.',
    date: '2026-8-20',
  ...
  },
  {
    ...
    imageAlt: 'A set of bilingual instructions in Chinese and English explaining how to prepare a strawberry beverage using cups, plastic wrap, filters, and coffee filters.',
    date: '2026-3-20',
  ...
  },
  {
    ...
    imageAlt: 'GeneLab logo with a red DNA strand, the words “GeneLab,” a moon, Mars, the International Space Station, and stars on a blue circular background.',
    date: '2025-6-20',
  ...
  },
  {
    ...
    imageAlt: 'A website with the text “Rock The Plastics!” appears over a textured gray background, with a cartoon rock character playing a red guitar on the right side.',
    date: '2025-10-20',
  ...
  },
  {
    ...
    imageAlt: 'Cartoon of a grey lump with googly eyes, arms, and legs, labeled “microplastics” underneath in lowercase letters.',
    date: '2025-8-20',
  ...
  },
  {
    ...
    imageAlt: 'Text “Rock The Plastics!” appears over a textured gray background, with a cartoon rock character playing a red guitar on the right side.',
    date: '2025-8-20',
